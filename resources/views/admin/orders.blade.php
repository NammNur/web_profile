...
@section('content')
    ...
    <div class="orders-header">
        ...
        <a href="{{ route('admin.orders.exportPdf', request()->query()) }}" class="btn-export-pdf">
                    ...
                    <tr>
                        ...
                        <td class="center">
                            @if ($o->bukti_pembayaran)
                                <a href="{{ asset('storage/' . $o->bukti_pembayaran) }}" target="_blank" class="btn-bukti">
                                    Lihat Bukti
                                </a>
                            @else
                        ...
                        <td class="center aksi-col">
                            @if ($o->status === 'pending')
                                <a href="{{ route('admin.orders.resiForm', $o->id) }}" class="status-btn proses">
                                    Proses
                                </a>
                            @else
                                -
